          ...
          <el-row>
            <div class="postInfo-container">
                ...
                <el-row>
                  ...
                  <el-col :span="3" style="margin-top: 10px;">
                    ...
                    <el-select v-if="analytics_code" v-model="analytics_code1" placeholder="Choose the Analytics Code" id="analytics_code1" clearable class="filter-item" style="width: 250px;">
                      <el-option v-for="item in accountsList1" :key="item.id" :label="item.analysis_name+': ' + item.code_id" :value="item.id" />
                    </el-select>
                  </el-col>
                </el-row>
              </el-row>
              ...
              <el-row >
                <el-row>
                  <el-col :span="5" style="margin-right: 10px;">
                    <el-form-item label="Functional area " class="postInfo-container-item">
            <span style="float: left; color:red; font-weight: bold;">*</span>
                      <span style="float: right; font-weight: bold;">:</span>
                    </el-form-item>
                  </el-col>
                  <el-col :span="18">
                    <el-input v-model="functional_area" :rows="1" type="textarea" class="article-textarea" autosize placeholder="Please enter the content" />
                  </el-col>
                </el-row>
              </el-row>
            </div>
  ...
  export default {
    ...
    methods: {
      ...
      store() {
        ...
        formdata.append('lookup', this.lookup);
        ...
        formdata.append('functional_area', this.functional_area);
        formdata.append('token', store.getters.token);
        this.axios.post(store.getters.api_route+'accounting/account/store', formdata, config)
          .then(res => {
            //console.log(res);
