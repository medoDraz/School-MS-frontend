<template>
  <div class="app-container" style="padding-top: 45px;">
    <div class="filter-container">
      ...
      <router-link :to="'/Orders/deleted_orders'">
        <el-button
          v-waves
          class="filter-item"
          type="primary"
    ...
    <el-table v-loading="listLoading" :data="ordersList" stripe>
      ...
      <el-table-column prop="order_date" label="Date" />
...
export default {
  ...
  methods: {
    ...
    getAllItems(page) {
      ...
      formdata.append('store_id', Number(this.cafeteria_id))
      formdata.append('token', store.getters.token)
      this.axios
        .post(
          store.getters.api_route + 'cafeteria/Orders/List?page=' + page,
          formdata,
          config
        )
        .then(res => {
    ...
    handleFilter() {
      ...
      this.axios
        .post(
          store.getters.api_route + 'cafeteria/Orders/List',
          formdata,
          config
        )
        .then(res => {
